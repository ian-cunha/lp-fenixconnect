      ...
      <div className="pattern">
        ...
        <p>
          <span>A sua privacidade é importante para nós. É política do Fenix Connect respeitar
            a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="http://fenixconnect.com.br/">Fenix Connect</a>
            , e outros sites que possuímos e operamos.</span>
        </p>
        <p>
          <span>Solicitamos informações pessoais apenas quando realmente precisamos delas para
            lhe fornecer um serviço. Fazemo-lo por meios justos e legais, com o seu conhecimento e consentimento. Também
            informamos por que estamos coletando e como será usado.</span>
        </p>
        <p>
          <span>Apenas retemos as informações coletadas pelo tempo necessário para fornecer o
            serviço solicitado. Quando armazenamos dados, protegemos dentro de meios comercialmente aceitáveis ​​para evitar
            perdas e roubos, bem como acesso, divulgação, cópia, uso ou modificação não autorizados.</span>
        </p>
        <p>
          <span>Não compartilhamos informações de identificação pessoal publicamente ou com
        ...
        <p>
          <span>Você é livre para recusar a nossa solicitação de informações pessoais,
            entendendo que talvez não possamos fornecer alguns dos serviços desejados.</span>
        </p>
        <p>
        ...
        <p>
          <span>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que
            o Fenix Connect oferece no site e com caráter enunciativo, mas não limitativo:</span>
        </p>
        <ul>
          <li><span>A - Não se envolver em atividades que sejam ilegais ou contrárias à boa fé
            a
          ...
          <li><span>C - Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares)
            do Fenix Connect, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou
            quaisquer
        ...
        <p>
          <span>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver
