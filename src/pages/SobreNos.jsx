        ...
        <div className="container marketing">
          ...
          <div className="row featurette pt-2">
            ...
            <div className="col-md-7">
              <h2 className="featurette-heading fw-normal lh-1 text-justify">Transformar vidas é nossa prioridade. <span className="text-body-secondary">Conectando você ao conhecimento que transforma sonhos em realidade.</span></h2>
            ...
            <div className="col-md-5">
              <img src={Equipe_Reportagem} alt="Equipe Responsável" className="rounded float-end img-flex" />
            </div>
          </div>
          ...
          <div className="row featurette pt-5">
            ...
            <div className="col-md-6 order-md-1">
              <ReactPlayer url="https://www.youtube.com/embed/XP3dbk8BEAE?si=8NElKibCoxvn4V1f" width="100%" className="float-home" />
            </div>
          </div>
              ...
              <div id="carouselExampleAutoplaying" className="carousel slide rounded float-end" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src={Equipe1} className="d-block rounded img-flex-banner" alt="Imagem do instituto." />
                  </div>
                  <div className="carousel-item">
                    <img src={Equipe4} className="d-block rounded img-flex-banner" alt="Imagem do instituto." />
                  </div>
                  <div className="carousel-item">
                    <img src={Equipe5} className="d-block rounded img-flex-banner" alt="Imagem do instituto." />
                  </div>
                </div>
